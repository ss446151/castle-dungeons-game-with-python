...
def Intro():
    ...
    print("Your choices, skills, and a bit of luck, will influence the outcone of the game.")
    print("")
...
def create_character():
    ...
    Let's begin by creating your own character.
    ...
    while character_race is None:
        race_choice=input("""
        Choose your character race from list below:
        1- Elf
        2- Dwarf
        >""")
    ...
    while character_class is None:
        class_choice=input("""
        Choose your character class from the list below:
        1- Warrior
        2- Wizard
        >""")
        if class_choice=="1":
...
def create_character_skill_sheet():
    ...
    -Life, which determines your life energy, points will be lost when hurt, and whenever life reaches 0, your character dies.
    Depending upon your race and class, you will have a certain point base already calculated by the game.
    You will shortly be able to increase your skills by rolling a six face die.

    Here is your base character skill set:
    """)
...
def modify_skills():
    ...
    print("To modify your skills, roll a six face die for each of your skills, and the game will add it to the existing skills.")
    ...
    print("""
    Congratulations! You have created your character creation.
...
def Scene_1():
    ...
    while choice is None:
        ...
        It is dark, however thankfully your torch is lit and you can see upto 20 feet away from you.
...
def Scene_2():
    ...
    while choice is None:
        user_input=input("""
        From the darkness behind you....you hear the strange noise...
        What do you do?
        1- Continue walking
        2- Stop to listen
        >""")
...
def skill_check():
    cls()
    print("A giant rock falls from the ceiling, roll a die to see if you can dodge it or you will be crushed.")
    roll=randint(1,6)
    print("You rolled: "+str(roll))

    if roll+character_dexterity > 10:
        print("""
        You dodge stone and survive!
        Danger is not over though....
